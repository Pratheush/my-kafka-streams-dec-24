...
import com.mylearning.advancedstreams.topology.ExploreAggregateOperatorsTopology;
...
public class AggregatingStreamPlayGroundApp {
    ...
    public static void main(String[] args) {
        ...
        createTopics(config, List.of(ExploreAggregateOperatorsTopology.AGGREGATE));
